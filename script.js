  ...
  handleEvent(event) {
    ...
    switch (event.type) {
      case 'click':
        ...
        if (event.target.closest('.message__settings')) {
          bool = !bool;
          // console.log(bool);
          if (bool == true) {
            document.querySelector(".message__settings-active").style.display = "flex"
            ...
            document.querySelector(".message__settings-active").style.display = "none";
          }
        }
